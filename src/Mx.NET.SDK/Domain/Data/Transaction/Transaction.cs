...
namespace Mx.NET.SDK.Domain.Data.Transaction
{
    public class Transaction
    {
        ...
        public async Task AwaitExecuted(IGenericApiProvider provider, TimeSpan? msCheck = null, TimeSpan? timeout = null)
        {
            if (!msCheck.HasValue)
        ...
        public async Task AwaitNotarized(IGenericApiProvider provider, TimeSpan? msCheck = null, TimeSpan? timeout = null)
        {
            if (!msCheck.HasValue)
                msCheck = TimeSpan.FromSeconds(1);
