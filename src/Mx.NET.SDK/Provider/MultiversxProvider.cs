...
{
    public class MultiversxProvider : IProvider
    {
        ...
        public async Task<Dtos.API.Account.AccountDto> GetAccount(string address)
        {
            return await GetApi<Dtos.API.Account.AccountDto>($"accounts/{address}?withGuardianInfo=true");
        ...
        public async Task<Dtos.API.Block.BlocksDto[]> GetBlocks(int size = 25, int from = 0, Dictionary<string, string> parameters = null)
        {
        ...
        public async Task<Dtos.API.Block.BlockDto> GetBlock(string blockHash)
        {
        ...
        public async Task<Dtos.API.Account.AccountDto> GetAccountByUsername(string username)
        {
